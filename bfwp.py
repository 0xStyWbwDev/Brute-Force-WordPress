...
if len(sys.argv) <= 1:
    ...
    print 'Website: https://setyowibowoid.site'
    print 'Mail   : nic3dre4m@yahoo.com'
    print ''
    ...
    print ''
    print 'Examples: python WP-crack.py -h https://web.com/wp-login.php -u admin -P listpass.txt'
    sys.exit()
